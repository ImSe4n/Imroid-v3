...
//Canvas.registerFont("./assets/fonts/Courier New.ttf", { family: "Courier New" } );
const Fonts = "Dosis";
        ...
        if (message.content.startsWith(prefix)) {
            ...
            switch (command) {
                ...
                break; 
                    /////////////////////////////////
                case `addpoints`:
                    if(message.author.id == "711602696133673011") return addpoints();
