  ...
  run: async (client, message, args, cmduser, text, prefix, player) => {
    ...
    try {
      ...
      .setAuthor(client.getAuthor(client.la[ls].cmds.info.serverinfo.author + " " +  message.guild.name, message.guild.iconURL({
        dynamic: true
      }), "https://discord.com/api/oauth2/authorize?client_id=954809003362357248&permissions=8&scope=bot%20applications.commands"))
      ...
      embed.addField("**<:Curvedrightarrow:960220710586953789> Rules Channel:**", `${message.guild.rulesChannel ? `<#${message.guild.rulesChannelId}>`: "<a:nah:960701828675297300> \`No Channel\`"}`, true)
      embed.addField("**<:Curvedrightarrow:960220710586953789> Public Updates Channel:**", `${message.guild.publicUpdatesChannel ? `<#${message.guild.publicUpdatesChannelId}>`: "<a:nah:960701828675297300> \`No Channel\`"}`, true)
      embed.addField("**<:Curvedrightarrow:960220710586953789> AFK Channel:**", `${message.guild.afkChannel ? `<#${message.guild.afkChannelId}>`: "<a:nah:960701828675297300> \`No Channel\`"}`, true)

      embed.addField("**<:Curvedrightarrow:960220710586953789> NSFW Level:**", `\`${message.guild.nsfwLevel}\``, true)
      embed.addField("**<:Curvedrightarrow:960220710586953789> Verifcation Level:**", `\`${message.guild.verificationLevel}\``, true)
      embed.addField("**<:Curvedrightarrow:960220710586953789> Explicit Content Filter:**", `\`${message.guild.explicitContentFilter}\``, true)
      ...
      if(boosts >= 14){
          embed.addField(`**<:Curvedrightarrow:960220710586953789> Vanity:**`, `${message.guild.vanityURLCode ? `https://discord.gg/${message.guild.vanityURLCode}` : "<a:nah:960701828675297300> No Vanity-Invite"}`)
      }
      ...
      if(message.guild.banner) {
        ...
        .setTitle(`**<:Curvedrightarrow:960220710586953789> SERVER BANNER:**`)
        ...
        let embed2 = new Discord.MessageEmbed()
        .setTitle(`**<:Curvedrightarrow:960220710586953789> SERVER DISCOVERY SPLASH:**`)
