  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    let ls = client.settings.get(message.guild.id, "language")
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<:Curvedrightarrow:960220710586953789> **Name**', "```"+json.name+"```", true)
        .addField("<:Curvedrightarrow:960220710586953789> **Hex**",  "```"+json.hex+"```", true)
        .addField("<:Curvedrightarrow:960220710586953789> **RGB**",  "```"+json.rgb+"```", true)
        .addField(`<:Curvedrightarrow:960220710586953789> **${client.la[ls].cmds.info.color.brightershade}**`,  "```"+json.brightened +"```", true)
