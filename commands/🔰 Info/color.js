  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    let ls = client.settings.get(message.guild.id, "language")
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<:arrow:959971239798120479> **Name**', "```"+json.name+"```", true)
        .addField("<:arrow:959971239798120479> **Hex**",  "```"+json.hex+"```", true)
        .addField("<:arrow:959971239798120479> **RGB**",  "```"+json.rgb+"```", true)
        .addField(`<:arrow:959971239798120479> **${client.la[ls].cmds.info.color.brightershade}**`,  "```"+json.brightened +"```", true)
