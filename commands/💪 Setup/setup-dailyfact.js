    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor('Daily Facts Setup', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/285/page-with-curl_1f4c3.png', 'https://dsc.gg/imroid-development')
                ...
                .then(async collected => {
                  ...
                  if(channel){
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`Posting now, every Day`.substring(0, 2048))
          ...
          case "Disable Daily fact":
            {
              ...
              return message.reply({embeds: [new Discord.MessageEmbed()
                ...
                .setColor(es.color)
                .setDescription(`I will not send automatic Facts to a Channel anymore`.substring(0, 2048))
                .setFooter(client.getFooter(es))
              ]});
            }
          break;
