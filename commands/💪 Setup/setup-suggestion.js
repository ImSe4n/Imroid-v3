  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      client.settings.ensure(message.guild.id, {
        suggest: {
          channel: "",
          approvemsg: `<a:yes:955154240664371222> Accepted Idea! Expect this soon.`,
          denymsg: `<a:no:955946429094953004> Thank you for the feedback, but we are not interested in this idea at this time.`,
