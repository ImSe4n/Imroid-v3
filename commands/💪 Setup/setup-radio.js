...
module.exports = {
    ...
    run: async (client, message, args, cmduser, text, prefix) => {
      ...
      try{
        ...
        //send the message of the searching <a:Playing_Owdio:956662822551572480> <a:Playing_Owdio:956662822551572480> 
        message.reply(
            new Discord.MessageEmbed()
                .setTitle("<a:Playing_Owdio:956662822551572480> Setup Complete for Radio Station:  " + song.title)
                .setColor("#7fafe3")
