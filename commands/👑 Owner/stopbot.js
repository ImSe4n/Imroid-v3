...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      return message.reply({content : `**<a:no:955946429094953004> THIS COMMAND IS DISABLED, go to https://dsc.gg/imroid-development and <#840332764603351101> to get it restarted!**\n\n\n> **Path:**
\`\`\`yml
${process.cwd()}
\`\`\`
> **Server:**
...
\`\`\``
      ...
      require("child_process").exec(`pm2 stop index.js imroid_bot_${process.cwd().split(require("path").sep).pop()}`, (error, stdout, stderr) => {
        if (error) {
